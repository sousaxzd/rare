...
import { faBoxOpen, faLayerGroup, faTicket, faLink, faBell, faUpRightFromSquare, faRocket } from '@fortawesome/free-solid-svg-icons'
...
const features = [
    {
        ...
        description: 'Crie e gerencie facilmente',
    },
    {
        icon: faLayerGroup,
        title: 'Categorias',
    ...
    },
    {
        ...
        description: 'URLs customizadas pós-compra',
    },
]
...
const additionalFeatures = [
    {
        icon: faDiscordBrand,
        title: 'Cargos no Discord',
        description: 'Entrega automática de roles',
    },
    {
        icon: faBell,
        title: 'Webhooks',
        description: 'Integração com seu sistema',
    },
]

export function BenefitsCheckoutSection() {
    return (
        <motion.section
            initial={{ opacity: 0 }}
        ...
        >
            <div className="relative z-10">
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    >
                        <img
                            src="/undraw_online-shopping_hgf6.svg"
                            alt="Checkout e Vendas"
                    ...
                    <div className="flex-1 lg:max-w-[55%]">
                        ...
                        >
                            ...
                            <span className="text-primary text-xs font-medium uppercase tracking-[0.2em]">Checkout</span>
                        </motion.div>
                        ...
                        >
                            Sistema de checkout completo para vender seus produtos digitais.
                            Configure categorias, cupons, entregas automáticas e integrações em minutos.
                        </motion.p>
