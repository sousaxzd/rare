      ...
      <div className="w-full max-w-7xl mx-auto relative overflow-hidden">
        ...
        <div className="relative w-full">
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-gradient-to-b from-background via-background/95 to-background rounded-3xl blur-2xl"
          />
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.6 }}
            transition={{ duration: 1, delay: 1.7 }}
            className="absolute inset-0 bg-gradient-to-r from-primary/10 via-transparent to-primary/10 rounded-3xl blur-xl"
          />
          ...
          {/* Decorative glow effects - contidos dentro do container */}
          <motion.div
