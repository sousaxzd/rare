      ...
      <div className="w-full max-w-7xl mx-auto relative">
        ...
        <div className="relative -mx-4 md:-mx-6">
          ...
          <motion.div
            ...
            className="relative rounded-2xl overflow-hidden bg-background border border-foreground/10 shadow-2xl dashboard-preview-3d cursor-pointer scale-90 md:scale-100"
          >
