    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-6 relative">
        ...
        <div className="relative -mx-6">
          ...
          <div className="absolute -inset-8 bg-gradient-to-b from-background via-background/95 to-background rounded-3xl blur-2xl opacity-80" />
          <div className="absolute -inset-4 bg-gradient-to-r from-primary/10 via-transparent to-primary/10 rounded-3xl blur-xl opacity-60" />
          ...
          <div className="absolute -inset-12 bg-primary/5 rounded-3xl blur-3xl -z-10 opacity-40" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-primary/5 rounded-full blur-[120px] -z-10 opacity-20" />
        </div>
      </div>
    </motion.section>
  )
